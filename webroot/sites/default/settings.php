...
/**
 * Database settings do NOT go here. Put them in settings.local.php.
 */
$databases = array();
...
/**
 * CircleCI override configuration, if available.
 */
if (file_exists(__DIR__ . '/settings.circleci.php')) {
  include __DIR__ . '/settings.circleci.php';
}

/**
 * Production override configuration, if available.
 */
